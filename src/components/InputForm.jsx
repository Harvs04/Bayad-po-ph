const InputForm = ({ startLocation, handleChangeInput, handleUserCurrentLocation, handleDeletePoint, markers, originSuggestions, debouncedStartLocation, handleSelectSuggestion, endLocation, destinationSuggestions, debouncedEndLocation, vehicleType, setVehicleType, passengerType, setPassengerType, fetchRoute, handleClearAll  }) => {
    return(
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              >
                ...
                <option value="traditional_jeepney">
                  🚐 Traditional Jeepney
                </option>
                ...
                <option value="aircon_city_bus">
                  ❄️ Airconditioned City Bus
                </option>
                <option value="ordinary_prov_bus">
                  🚌 Ordinary Provincial Bus
                </option>
                <option value="aircon_prov_bus">
                  ❄️ Airconditioned Provincial Bus
                </option>
